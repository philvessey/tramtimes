...
public class Stop(BlackpoolFixture fixture)
{
    [Fact]
    ...
    [Theory]
    [InlineData("9400ZZBPBWR", true)]
    [InlineData("9400ZZBPCBN", true)]
    [InlineData("9400ZZBPCLY", true)]
    [InlineData("9400ZZBPNBK", true)]
    [InlineData("9400ZZBPNRS", true)]
    [InlineData("9400ZZBPSHP", true)]
    [InlineData("9400ZZBPTOW", true)]
