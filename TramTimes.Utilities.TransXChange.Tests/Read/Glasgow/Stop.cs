...
public class Stop(GlasgowFixture fixture)
{
    [Fact]
    ...
    [Theory]
    [InlineData("9400ZZGLBRI", true)]
    [InlineData("9400ZZGLCES", true)]
    [InlineData("9400ZZGLGOV", true)]
    [InlineData("9400ZZGLIBX", true)]
    [InlineData("9400ZZGLPRT", true)]
    [InlineData("9400ZZGLSTE", true)]
    [InlineData("9400ZZGLWES", true)]
