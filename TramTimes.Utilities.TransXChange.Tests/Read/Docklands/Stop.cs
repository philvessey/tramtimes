...
public class Stop(DocklandsFixture fixture)
{
    [Fact]
    ...
    [Theory]
    [InlineData("9400ZZDLALL", true)]
    [InlineData("9400ZZDLCAN", true)]
    [InlineData("9400ZZDLLIM", true)]
    [InlineData("9400ZZDLMUD", true)]
    [InlineData("9400ZZDLPOP", true)]
    [InlineData("9400ZZDLSTD", true)]
    [InlineData("9400ZZDLWFE", true)]
