...
public class Stop(LondonFixture fixture)
{
    [Fact]
    ...
    [Theory]
    [InlineData("9400ZZCRADD", true)]
    [InlineData("9400ZZCRBEK", true)]
    [InlineData("9400ZZCRECR", true)]
    [InlineData("9400ZZCRLEB", true)]
    [InlineData("9400ZZCRMTP", true)]
    [InlineData("9400ZZCRSAN", true)]
    [InlineData("9400ZZCRWAN", true)]
