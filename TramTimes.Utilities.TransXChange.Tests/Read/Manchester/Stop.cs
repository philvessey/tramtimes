...
public class Stop(ManchesterFixture fixture)
{
    [Fact]
    ...
    [Theory]
    [InlineData("9400ZZMAAIR", true)]
    [InlineData("9400ZZMABKS", true)]
    [InlineData("9400ZZMACRN", true)]
    [InlineData("9400ZZMAECS", true)]
    [InlineData("9400ZZMAMKT", true)]
    [InlineData("9400ZZMAOLD", true)]
    [InlineData("9400ZZMASQY", true)]
