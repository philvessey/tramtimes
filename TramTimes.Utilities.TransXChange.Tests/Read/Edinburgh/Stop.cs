...
public class Stop(EdinburghFixture fixture)
{
    [Fact]
    ...
    [Theory]
    [InlineData("9400ZZEDAIR", true)]
    [InlineData("9400ZZEDBAN", true)]
    [InlineData("9400ZZEDHAY", true)]
    [InlineData("9400ZZEDMUR", true)]
    [InlineData("9400ZZEDPKS", true)]
    [InlineData("9400ZZEDSAU", true)]
    [InlineData("9400ZZEDSTA", true)]
